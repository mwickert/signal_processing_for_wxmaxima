...
The documentation was build using [Typst](https://typst.app/home/) and working in wxMaxima document. [Documentation pdf](docs/sp_tools_wxmaxima.pdf) is contained in the `docs` folder. 